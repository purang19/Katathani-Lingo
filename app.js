...
const MODULES = [{
  ...
  questions: [{
    ...
    options: [{
      t: "Sawasdee kha. Welcome to Talay Restaurant. Do you have a reservation?",
      th: "สวัสดีค่ะ ยินดีต้อนรับสู่ห้องอาหารทะเล คุณได้จองโต๊ะไว้หรือไม่คะ",
      v: "best",
  ...
  questions: [{
    ...
    options: [{
      t: "Excuse me, sir. I would like to inform you that we have a corkage charge of 300 baht per bottle.",
      th: "ขออนุญาตแจ้งค่ะ เรามีค่าบริการเปิดขวด 300 บาทต่อขวดค่ะ",
      v: "best",
      ...
      v: "bad",
      n: "You just gave away 300 baht and you will have to explain it at the bill.",
      nTh: "คุณเพิ่งทำโรงแรมเสีย 300 บาท และต้องไปอธิบายตอนเก็บเงิน"
    }, {
      t: "There is a small charge, I think.",
      th: "น่าจะมีค่าบริการนิดหน่อยนะคะ",
      v: "ok",
      n: "Never say 'I think' about a price. Know the number: 300 baht per bottle.",
      nTh: "ห้ามพูดว่าน่าจะ เกี่ยวกับราคา ต้องรู้ตัวเลข 300 บาทต่อขวด"
    }]
  }, {
    type: "guest",
  ...
  questions: [{
    ...
    options: [{
      t: "I would recommend Talay, right on the beach. You can watch the sunset while you have dinner, we have live music, and our chef will cook the fresh seafood any way you like.",
      th: "ขอแนะนำห้องอาหารทะเลค่ะ ตั้งอยู่ริมหาดเลย คุณสามารถชมพระอาทิตย์ตกระหว่างทานอาหารค่ำ มีดนตรีสด และเชฟของเราปรุงอาหารทะเลสด ๆ ตามที่คุณต้องการได้ค่ะ",
      v: "best",
      ...
      t: "Talay Restaurant serves seafood. It is on the beach.",
      th: "ห้องอาหารทะเลเสิร์ฟซีฟู้ด อยู่ริมหาดค่ะ",
      v: "ok",
      n: "Both true. Neither of them makes a booking.",
      nTh: "จริงทั้งสองอย่าง แต่ไม่ทำให้ลูกค้าจอง"
    }, {
      t: "Talay is our seafood restaurant.",
      th: "ทะเลคือห้องอาหารซีฟู้ดของเราค่ะ",
      v: "bad",
    ...
    guest: {
      en: "OK, I'll go to Talay tonight.",
      th: "ตกลง คืนนี้ไปห้องอาหารทะเลนะ"
    },
    ...
    askTh: "แนะนำสถานที่",
    options: [{
      t: "I would recommend the Tsunami Museum — about ten minutes by taxi. It is opposite Bang Niang market, which is open Monday, Wednesday, Thursday and Saturday, from 2 to 9 p.m.",
      th: "ขอแนะนำพิพิธภัณฑ์สึนามิค่ะ นั่งแท็กซี่ประมาณ 10 นาที อยู่ตรงข้ามตลาดบางเนียง ซึ่งเปิดวันจันทร์ พุธ พฤหัสบดี และเสาร์ ตั้งแต่ 14:00 ถึง 21:00 น. ค่ะ",
      v: "best",
...
function App() {
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsx("style", {
      ...
      className: "se-phone",
      children: [view === "home" && loaded && /*#__PURE__*/_jsx(Home, {
        progress: progress,
        xp: xp,
        thaiOn: thaiOn,
      ...
      }), view === "lesson" && active && /*#__PURE__*/_jsx(Lesson, {
        module: active,
        thaiOn: thaiOn,
        onQuit: () => setView("home"),
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsxs("div", {
        children: [/*#__PURE__*/_jsx("h1", {
          children: "Katathani Lingo"
        }), /*#__PURE__*/_jsx("div", {
          className: "sub",
          children: "Learn. Practice. Serve."
        })]
      }), /*#__PURE__*/_jsxs("div", {
        className: "xp",
        children: [xp, /*#__PURE__*/_jsx("small", {
          children: "XP"
        })]
      })]
    }), /*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx("b", {
        ...
        children: "The Sands · Food & Beverage"
      }), /*#__PURE__*/_jsxs("span", {
        style: {
          display: "block"
        },
        children: [totalQ, " real situations from the floor."]
      }), /*#__PURE__*/_jsxs("span", {
        className: "th",
        style: {
          display: "block"
        },
        children: [totalQ, " สถานการณ์จริงจากหน้างาน ฝึกวันละ 5 นาทีก่อนเข้ากะ"]
      })]
      ...
      children: [/*#__PURE__*/_jsx("div", {
        ...
        className: "lb",
        children: [thaiOn ? "Thai meaning shown" : "English only", /*#__PURE__*/_jsx("span", {
          className: "th",
          children: thaiOn ? "แสดงคำแปลภาษาไทย" : "ซ่อนคำแปล — ทดสอบตัวเอง"
        })]
      })]
    }), /*#__PURE__*/_jsxs("div", {
      style: {
      ...
      children: [/*#__PURE__*/_jsx("button", {
        ...
        children: "◗ Test the sound · ทดสอบเสียง"
      }), sound === "ok" && /*#__PURE__*/_jsxs("div", {
        style: {
          fontSize: 12,
          color: "var(--ink-soft)",
          marginTop: 8,
        ...
        children: ["You should have heard “Good evening. Welcome to The Sands.” If not, check the side switch on your phone and turn the volume up — the silent switch mutes speech.", /*#__PURE__*/_jsx("span", {
          className: "th",
          style: {
            display: "block"
          },
          children: "หากไม่ได้ยิน ให้ตรวจสอบสวิตช์ปิดเสียงด้านข้างเครื่อง และเพิ่มระดับเสียง"
        })]
      }), sound === "none" && /*#__PURE__*/_jsxs("div", {
        style: {
          fontSize: 12,
          color: "var(--coral)",
          marginTop: 8,
        ...
        children: ["This browser has no speech voice. Try opening the app in Chrome or Safari directly.", /*#__PURE__*/_jsx("span", {
          className: "th",
          style: {
            display: "block"
          },
          children: "เบราว์เซอร์นี้ไม่มีเสียงพูด ลองเปิดแอปใน Chrome หรือ Safari โดยตรง"
        })]
      })]
    }), /*#__PURE__*/_jsx("div", {
      className: "list",
      children: MODULES.map((m, i) => {
        ...
        return /*#__PURE__*/_jsxs("button", {
          ...
          children: [/*#__PURE__*/_jsx("div", {
            ...
            children: pct >= 80 ? "✓" : String(i + 1).padStart(2, "0")
          }), /*#__PURE__*/_jsxs("div", {
            className: "body",
            children: [/*#__PURE__*/_jsx("div", {
              className: "en",
              ...
              children: [/*#__PURE__*/_jsx("div", {
                ...
                children: pct ? pct + "%" : m.questions.length + " questions"
              })]
            })]
          })]
        }, m.id);
  ...
  if (state === "finished") {
    ...
    return /*#__PURE__*/_jsxs(_Fragment, {
      children: [/*#__PURE__*/_jsx("div", {
        ...
        children: [/*#__PURE__*/_jsxs("div", {
          className: "score",
          children: [pct, /*#__PURE__*/_jsx("small", {
            children: "%"
          })]
        }), /*#__PURE__*/_jsx("h2", {
          children: pct >= 90 ? "Excellent." : pct >= 70 ? "Good work." : "Keep practising."
        }), /*#__PURE__*/_jsxs("p", {
          children: [earned, " of ", max, " points · ", mod.en, /*#__PURE__*/_jsx("br", {}), /*#__PURE__*/_jsx("span", {
            className: "th",
            children: pct >= 90 ? "เยี่ยมมาก พร้อมขึ้นกะแล้ว" : pct >= 70 ? "ดีแล้ว ลองอีกครั้งให้ได้ 90%" : "ลองทำอีกรอบนะคะ"
          })]
        }), misses.length > 0 && /*#__PURE__*/_jsxs("div", {
          className: "recap",
          children: [/*#__PURE__*/_jsx("h3", {
            children: "Worth remembering · ควรจำไว้"
          }), /*#__PURE__*/_jsx("ul", {
            children: misses.map((m, k) => /*#__PURE__*/_jsxs("li", {
              children: [m.correct, /*#__PURE__*/_jsx("span", {
                className: "th",
                children: m.th
          ...
          children: "Back to units · กลับหน้าหลัก"
        })]
      })]
    });
  }
  ...
  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx("button", {
        ...
        children: [i + 1, "/", mod.questions.length]
      })]
    }), /*#__PURE__*/_jsxs("div", {
      className: "q",
      children: [/*#__PURE__*/_jsx("div", {
        ...
        className: "scene",
        children: [q.scene, thaiOn && /*#__PURE__*/_jsx("span", {
          className: "thai th",
          children: q.sceneTh
        })]
      }), /*#__PURE__*/_jsxs("div", {
        className: "ask",
        children: [q.ask, thaiOn && /*#__PURE__*/_jsx("span", {
          className: "thai th",
          children: q.askTh
        })]
      }), q.guest && /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsxs("div", {
          className: "guest",
          children: [/*#__PURE__*/_jsx("div", {
            className: "who",
            children: "The guest says · ลูกค้าพูดว่า"
          }), /*#__PURE__*/_jsxs("div", {
            className: "said",
            children: ["“", q.guest.en, "”"]
          }), /*#__PURE__*/_jsx("div", {
      ...
      }), (q.type === "choice" || q.type === "guest") && /*#__PURE__*/_jsx("div", {
        className: "opts",
        children: opts.map((o, k) => {
          let c = "opt";
          if (state === "judged") {
          ...
          return /*#__PURE__*/_jsxs("button", {
            ...
            children: [o.t, thaiOn && /*#__PURE__*/_jsx("span", {
              className: "thai th",
              children: o.th
            })]
          }, k);
        })
      }), q.type === "order" && /*#__PURE__*/_jsxs(_Fragment, {
        children: [thaiOn && /*#__PURE__*/_jsx("div", {
          className: "hint th",
          children: q.th
        }), /*#__PURE__*/_jsx("div", {
          className: "slot",
          children: built.map((w, k) => /*#__PURE__*/_jsx("button", {
            className: "chip",
            disabled: state === "judged",
      ...
      }), q.type === "gap" && /*#__PURE__*/_jsxs(_Fragment, {
        children: [thaiOn && /*#__PURE__*/_jsx("div", {
          className: "hint th",
          children: q.th
        }), /*#__PURE__*/_jsx("div", {
          ...
          children: /*#__PURE__*/_jsxs("div", {
            ...
            children: [q.sentence[0], " ", /*#__PURE__*/_jsx("span", {
              style: {
          ...
          className: "bank",
          children: bank.map((w, k) => /*#__PURE__*/_jsx("button", {
      ...
      className: "foot " + cls,
      children: [state === "asking" && (q.type === "order" || q.type === "gap") && /*#__PURE__*/_jsx("button", {
        className: "cta",
        disabled: !canSubmit,
        onClick: judgeBuild,
        children: "Check · ตรวจคำตอบ"
      }), state === "asking" && (q.type === "choice" || q.type === "guest") && /*#__PURE__*/_jsxs("div", {
        style: {
          fontSize: 12.5,
          color: "var(--ink-soft)",
          textAlign: "center",
        ...
        children: ["Choose what you would actually say to the guest.", /*#__PURE__*/_jsx("span", {
          className: "th",
          style: {
            display: "block"
          },
          children: "เลือกประโยคที่คุณจะพูดกับลูกค้าจริง ๆ"
        })]
      }), state === "judged" && /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsxs("div", {
          className: "verdict " + cls,
          children: [picked.v === "best" && /*#__PURE__*/_jsxs("span", {
            children: ["✓ That is the one. ", /*#__PURE__*/_jsx("span", {
              className: "th",
              children: "ถูกต้อง"
            })]
          }), picked.v === "ok" && /*#__PURE__*/_jsxs("span", {
            children: ["◐ Correct — but there is a warmer way. ", /*#__PURE__*/_jsx("span", {
              className: "th",
              children: "ถูก แต่ยังมีวิธีพูดที่อบอุ่นกว่านี้"
            })]
          }), picked.v === "bad" && /*#__PURE__*/_jsxs("span", {
            children: ["✕ Not this one. ", /*#__PURE__*/_jsx("span", {
              className: "th",
              children: "ไม่ใช่ข้อนี้"
            })]
          })]
        }), picked.n && /*#__PURE__*/_jsxs("div", {
          className: "note",
          children: [picked.n, thaiOn && /*#__PURE__*/_jsx("span", {
            className: "thai th",
            children: picked.nTh
          })]
        }), /*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsx("span", {
            className: "lbl",
            children: "Say this · ให้พูดแบบนี้"
          }), /*#__PURE__*/_jsx("b", {
            children: targetSentence
          }), /*#__PURE__*/_jsx("span", {
            className: "thai th",
            children: bestLine ? bestLine.th : q.th
          }), /*#__PURE__*/_jsxs("div", {
            className: "audio",
            style: {
              marginTop: 10
        ...
        }), prons.length > 0 && /*#__PURE__*/_jsxs("div", {
          className: "pron",
          children: [/*#__PURE__*/_jsx("span", {
            className: "lbl",
            children: "Say it right · ออกเสียงให้ถูก"
          }), /*#__PURE__*/_jsx("ul", {
            children: prons.map((p, k) => /*#__PURE__*/_jsxs("li", {
              children: [/*#__PURE__*/_jsx("span", {
                className: "say",
                children: p.say
              }), /*#__PURE__*/_jsxs("span", {
                className: "tip",
                children: [p.tip, thaiOn && /*#__PURE__*/_jsx("span", {
                  className: "th",
                  style: {
                    display: "block"
                  },
          ...
          className: "cta dark",
          onClick: next,
          children: i + 1 >= mod.questions.length ? "Finish · จบบทเรียน" : "Continue · ทำต่อ"
        })]
      })]
    })]
  });
